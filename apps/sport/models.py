...
class Program(models.Model):
    ...
    imgCover = models.CharField(default='',  max_length=200, verbose_name="封面图", help_text="封面图")
    imgCoverBig = models.CharField(default='', max_length=200, verbose_name="封面大图", help_text="封面大图")
    restIndexArray = models.CharField(default='', max_length=100, verbose_name="休息Index", help_text="休息Index")
